...
\label{sec:secrecy}
% - in academic setting, we are free to explore parameters
% - in operational setting, when run online, that's not that easy as attackers
%   would leverage that to test attack offline.
% 
% 
