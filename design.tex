...
string $s_2$ into $s_1$, six operations are necessary; three modifications
...
ascending order and prints the most similar relays to the console.  For a
consensus consisting of 6,525 relays, our algorithm takes approximately 1.5
seconds to finish.\footnote{We measured on an Intel Core i7-3520M CPU at 2.9
