...
whose uptime is highly correlated.

This technique is similar to the above section, but the churn technique only
...
append a new data point to each Tor relay's sequence, representing ``online'' or
``offline.'' We visualize all sequences in a bitmap whose rows represent
...
We avoid the use of opaque classification methods such as Support Vector
